    ...
    return(
      <>
        <div className="w-full h-100vh bg-black flex flex-col items-center justify-center pb-20 ">
          <a
            href="https://mail.google.com/mail/?view=cm&fs=1&to=your-email@gmail.com&su=Contact%20Inquiry&body=Hello,%20I%20would%20like%20to%20connect!"
            target="_blank"
            rel="noopener noreferrer"
            >
            <button className="font-chokokutai text-xl text-[#EFC7B0] border border-[#EFC7B0] px-10 py-3 flex items-center  hover:bg-[#8f6046] hover:text-white transition duration-700 gap-5">
              Contact us
